...
export default function BoardListItem({ item }: Props) {
   ...
   return (
      <section className="flex items-center  flex-wrap p-2  ">
         <span className="w-18 block text-sm text-muted-foreground overflow-hidden text-ellipsis whitespace-nowrap text-left">
            {id}
         </span>
         ...
         <div className="flex-1 min-w-0">
            {deleted ? (
               <p className="text-muted-foreground">삭제된 게시물입니다.</p>
            ) : (
               <Link
