  ...
  return (
    <div className="flex gap-3 w-full justify-between sm:mx-auto">
      <Button
        ...
        variant="outline"
        className="flex-1 bg-white dark:bg-black border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-gray-700 dark:text-gray-200"
      >
