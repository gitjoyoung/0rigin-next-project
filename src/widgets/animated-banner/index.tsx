      ...
      <div className="relative w-full sm:h-[400px] h-[300px]">
         ...
         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center flex flex-col gap-4 w-[90%] ">
            <div className="relative">
               <p className="absolute inset-0 text-base sm:text-xl text-black dark:text-white italic whitespace-pre-wrap blur-sm">
            ...
            <div className="relative">
               <p className="absolute inset-0 text-xs sm:text-sm text-black dark:text-white italic whitespace-pre-wrap blur-sm">
                  {currentQuote.author}
               </p>
